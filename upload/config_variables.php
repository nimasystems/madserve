...
{
	define('DEBUG', 1);
	define('DEBUG_GEO_CCODE', 'US');
	define('DEBUG_GEO_REGION', 'NEW YORK');
	...
	define('MAD_TRACK_UNIQUE_CLICKS', true); // Track only unique clicks. Works only if a caching method is enabled.
	...
	// cache settings
	define('MAD_ENABLE_CACHE', true);
	define('MAD_DEFAULT_CACHE', 'Memcache'); // Possible Values: File (File Cache: data/cache/ needs to be writeable, otherwise script will crash), APC, Memcache, Memcached, Redis, WinCache, XCache, ZendCache, ZendSHM, eAccelerator
	define('MAD_FILE_CACHE_DIR', 'data/cache/');

	// time zone settings
	define('MAD_TIMEZONE_OVERRIDE', true); // Override Server Time Zone
	define('MAD_DEFAULT_TIMEZONE', 'Europe/Sofia'); // Time Zone to use. e.g. 'America/Los_Angeles' / Full List of Time Zones supported: http://www.php.net/manual/en/timezones.php
